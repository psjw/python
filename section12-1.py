...
#sqlite3
print('sqlite3.version : ',sqlite3.version)#sqllite버전
print('sqlite3.sqlite_version : ',sqlite3.sqlite_version) #DB엔진버전

# DB 생성 & Auto Commit(Rollback)
conn = sqlite3.connect('C:/ljw-study/python/PYTHON_BASIC/resource/database.db',isolation_level=None) #isolation_level=None AutoCommit
...
# 커밋 : isolation_level 일 경우 자동 반영(으로 커밋)
# conn.commit()
